...
{
/*	14) Create a program to get the hashmap from the given input string array 
 * where the key for the hashmap is first three letters of array element in uppercase
